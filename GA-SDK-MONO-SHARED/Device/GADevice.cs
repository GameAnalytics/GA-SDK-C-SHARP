...
namespace GameAnalyticsSDK.Net.Device
{
	...
	{
#if WINDOWS_UWP
        private const string _sdkWrapperVersion = "uwp 1.1.10";
#elif WINDOWS_WSA
        private const string _sdkWrapperVersion = "wsa 1.1.10";
#else
        private const string _sdkWrapperVersion = "mono 1.1.10";
#endif
#if UNITY
