...
namespace GameAnalyticsSDK.Net.Device
{
	...
	{
#if WINDOWS_UWP
        private const string _sdkWrapperVersion = "uwp 1.1.12";
#elif WINDOWS_WSA
        private const string _sdkWrapperVersion = "wsa 1.1.12";
#else
        private const string _sdkWrapperVersion = "mono 1.1.12";
#endif
#if UNITY
